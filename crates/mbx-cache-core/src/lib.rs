...
pub use agent::{
    ...
    FileDigestResolution, FileDigestScope, FileIdentity, FileObjectIdentity, FileObservation,
    FileObservationMatch, FileObservationResolution, FileSnapshot, NoFileDigestCache, PinnedFile,
    PinnedState, RecordedFileDigest, RestoreStats, WrapperSpan, WrapperTiming, digest_file,
